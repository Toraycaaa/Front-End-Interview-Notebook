...
![img](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627140033.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627140739.png)

在这之前需要了解一个重要的性能指标 RTT。该指标表示发送端发送数据到接收到对端数据所需的往返时间。

### 建立连接三次握手

![img](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627141141.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627141216.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627141329.png)

发送端窗口是由接收窗口剩余大小决定的。接收方会把当前接收窗口的剩余大小写入应答报文，发送端收到应答后根据该值和当前网络拥塞情况设置发送窗口的大小，所以发送窗口的大小是不断变化的。

当发送端接收到应答报文后，会随之将窗口进行滑动

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627141335.png)
