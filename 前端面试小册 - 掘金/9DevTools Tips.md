...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215511.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215516.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215521.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215527.png)

当我们给 `ul` 添加该断点以后，一旦 `ul` 子元素发生了改动，比如说增加了子元素的个数，那么就会自动跳转到对应的 JS 代码

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215534.png)

其实不光可以给 DOM 打断点，我们还可以给 Ajax 或者 Event Listener 打断点。

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215540.png)

### 查看事件

我们还可以通过 DevTools 来查看页面中添加了多少的事件。假如当你发现页面滚动起来有性能上的问题时，就可以查看一下有多少 `scroll` 事件被添加了

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215545.png)

### 找到之前查看过的 DOM 元素

不知道你是否遇到过这样的问题，找不到之前查看过的 DOM 元素在哪里了，需要一个个去找这就有点麻烦了，这时候你就可以使用这个功能。

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215552.png)

我们可以通过 `$0` 来找到上一次查看过的 DOM 元素，`$1` 就是上上次的元素，之后以此类推。这时候你可能会说，打印出来元素有啥用，在具体什么位置还要去找啊，不用急，马上我就可以解决这个问题

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215557.png)
...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215603.png)

首先我们先右键断点，然后选择 `Edit breakpoint...` 选项

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215609.png)

在弹框内输入 `index === 5`，这样断点就会变为橙色，并且只有当符合表达式的情况时断点才会被执行

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210626215615.png)
