...
![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627095006.png "Audits 所处位置")

点我们点击 Audits 后，可以看到如下的界面

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627095019.png "Audits 界面")

在这个界面中，我们可以选择想测试的功能然后点击 **Run audits** ，工具就会自动运行帮助我们测试问题并且给出一个完整的报告

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627095025.png "Audits 工具给出的报告")

上图是给掘金首页测试性能后给出的一个报告，可以看到报告中分别为**性能、体验、SEO** 都给出了打分，并且每一个指标都有详细的**评估**

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627095032.png "指标中的详细评估")

评估结束后，工具还提供了一些**建议**便于我们提高这个指标的分数

![img](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627100444.png)

我们只需要一条条根据建议去优化性能即可。

除了 **Audits** 工具之外，还有一个 **Performance** 工具也可以供我们使用。

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627095522.png "Performance 工具给出的报告")
...
![img](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627100523.png)

从上图中我们可以发现，JS 会首先被解析为 AST，解析的过程其实是略慢的。代码越多，解析的过程也就耗费越长，这也是我们需要压缩代码的原因之一。另外一种减少解析时间的方式是预解析，会作用于未执行的函数，这个我们下面再谈。

![](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627095954.png "2016 年手机解析 JS 代码的速度")
...
![img](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627100557.png)
...
![img](https://cdn.jsdelivr.net/gh/huxingyi1997/my_img/img/20210627102645.png)
